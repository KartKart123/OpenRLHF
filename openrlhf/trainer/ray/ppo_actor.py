...
class ActorPPOTrainer(BasePPOTrainer):
    ...
    def ppo_train_actor(self, global_steps):
        ...
        for epoch in range(self.max_epochs):
            ...
            for experience in pbar:
                ...
                status = self.training_step(experience, epoch)
    ...
    def training_step(self, experience: Experience, epoch: int) -> Dict[str, float]:
        self.actor.train()
        ...
        if epoch == 0:
            ...
            old_action_log_probs = action_log_probs
...
class ActorModelRayActor(BasePPORole):
    def init_model_from_pretrained(self, strategy: DeepspeedStrategy, pretrain):
        ...
        actor_scheduler = get_scheduler(
            "constant_with_warmup", # TODO add argument in script
            actor_optim,
